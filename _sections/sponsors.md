...
<div class="container" style="padding: 0px">
	...
	<div class="row align-items-center" id="sponsor-rows">
		...
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://equinox-eng.com/"><img class="img-fluid" src="/resources/img/sponsors/equinox.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://www.finning.com/regions.html"><img class="img-fluid" src="/resources/img/sponsors/finning.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://www.hatch.com/"><img class="img-fluid" src="/resources/img/sponsors/hatch.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://isacalgary.ca/"><img class="img-fluid" src="/resources/img/sponsors/isa.jpg"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
		...
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="http://www.valard.com/"><img class="img-fluid" src="/resources/img/sponsors/Valard.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://www.viseenergy.ca/"><img class="img-fluid" src="/resources/img/sponsors/vise.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://vortexservices.ca/"><img class="img-fluid" src="/resources/img/sponsors/vortex.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
			<a href="https://www.weavergroupltd.ca/"><img class="img-fluid" src="/resources/img/sponsors/weaverGL.png"></a>
		</div>
		<div class="col-4 col-md-4 col-lg-3" id="sponsor-cols">
